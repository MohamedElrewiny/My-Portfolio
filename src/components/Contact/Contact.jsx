...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_02nc8xb", "template_snbizbm", form.current, {
      publicKey: "ZtxR6m7GN4tcEw7pc",
    });
    e.target.reset();
  };
  return (
          ...
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">moo.web22@gmail.com</span>
                <a
                  href="mailto:moo.web22@gmail.com"
